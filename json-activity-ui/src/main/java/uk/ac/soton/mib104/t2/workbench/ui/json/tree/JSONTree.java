...
public final class JSONTree extends JTree {
	...
	/**
	 * Returns the shared instance of the empty tree selection model, which does not
	 * allow anything to be selected.
	 * 
	 * @return  the empty tree selection model
	 */
	public static final TreeSelectionModel emptySelectionModel() {
	...
	@Override
	public final String convertValueToText(final Object value, final boolean selected, final boolean expanded, final boolean leaf, final int row, final boolean hasFocus) {
		if (value == null) {
			return super.convertValueToText(value, selected, expanded, leaf, row, hasFocus);
		} else if (value instanceof JSONTreeNode) {
			// If the given 'value' is an instance of the JSONTreeNode class, then delegate the method call. 
			return ((JSONTreeNode<?, ?>) value).convertToText(selected, expanded, leaf, row, hasFocus);
		} else {
			return super.convertValueToText(value, selected, expanded, leaf, row, hasFocus);
		}
	}
